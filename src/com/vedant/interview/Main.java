...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (minval < maxval && (minval + 10) <= maxval){
                rangeCorrect = true;
                    ...
                    System.out.println("The minimum has to be less then the maximum, and at least 10 numbers apart " + minval + " " + maxval);
            }
        ...
        randomNumberGen = rand.nextInt(maxval) + minval; //Random number assignment, default is 50
        ...
        do{
            ...
            if (guess == randomNumberGen) correctGuess = true;
